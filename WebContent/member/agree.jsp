...
function chk(){
 ...
 if(num==1){
  ...
  location.href="<%=request.getContextPath()%>/index.jsp?workgroup=member&work=agree";}
 }
...
<body>
<form action="/margaret/index.jsp?workgroup=member&work=member_join" name="form" method="post">
<table width="1400" height="650">
  ...
  <tr>
   ...
   <br>
   <div class="boxTheme agreeArea">
   <h3>[필수] 이용약관 동의</h3>
	<div class="content">
		<textarea>
			제1조(목적)
			이 약관은 주식회사 서륭(전자상거래 사업자)이 운영하는 마가렛호웰 온라인(이하 “몰”이라 한다)에서 제공하는
			...
			제2조(정의)
			① “몰”이란 주식회사 서륭이 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등
			...
			제8조(회원에 대한 통지)
			① “몰”이 회원에 대한 통지를 하는 경우, 회원이 “몰”과 미리 약정하여 지정한 전자우편 주소로 할 수
				있습니다.
			...
			① “몰”이용자는 “몰”상에서 다음 또는 이와 유사한 방법에 의하여 구매를 신청하며, “몰”은 이용자가
				구매신청을 함에 있어서 다음의 각 내용을 알기 쉽게 제공하여야 합니다. (삭제)
			&nbsp; 1. 재화 등의 검색 및 선택
			...
			② “몰”이 제3자에게 구매자 개인정보를 제공•위탁할 필요가 있는 경우 실제 구매신청 시 구매자의 동의를 받아야
				...
				관한 법률」 제25조 제1항에 의한 개인정보 처리위탁의 경우 등 관련 법령에 달리 정함이 있는 경우에는 그에 따릅니다.
			...
			④ “몰”은 수집된 개인정보를 목적외의 용도로 이용할 수 없으며, 새로운 이용목적이 발생한 경우 또는 제3자에게
				...
				있는 경우에는 예외로 합니다.
			⑤ “몰”이 제2항과 제3항에 의해 이용자의 동의를 받아야 하는 경우에는 개인정보보호 책임자의 신원(소속, 성명
			...
			부 칙(시행일) 이 약관은 2018년 9월 1일부터 시행합니다.
	...
	<div class="content">
		<textarea>
			...
			회원제 서비스 이용에 따른 본인확인 , 개인 식별 , 불량회원의 부정 이용 방지와 비인가 사용 방지 , 가입
				...
				고지사항 전달
			2. 수집하는 개인정보 항목 : 이름 , 생년월일 , 성별 , 로그인ID , 비밀번호 , 자택 전화번호 ,
  ...
  <tr>
   <td align="center" valign="top">
    <input type="button" value="회원가입으로이동" onclick="chk()" id="son" />
    <input type="button" value="동의하지 않습니다" onclick="nochk()"id="son"/>
   </td>
  </tr>
 </table>
</form>
